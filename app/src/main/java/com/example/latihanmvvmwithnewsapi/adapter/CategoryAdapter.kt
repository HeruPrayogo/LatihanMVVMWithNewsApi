...
import com.example.latihanmvvmwithnewsapi.databinding.ItemCategoryBinding
import com.example.latihanmvvmwithnewsapi.model.Category

class CategoryAdapter (var listCategory: List<Category>): RecyclerView.Adapter<CategoryAdapter.ViewHolder>() {
